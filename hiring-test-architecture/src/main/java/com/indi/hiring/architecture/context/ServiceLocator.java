package com.indi.hiring.architecture.context;

import jakarta.inject.Singleton;
import static org.slf4j.LoggerFactory.getLogger;
import com.indi.hiring.architecture.context.holder.ContextHolder;

@Singleton
public final class ServiceLocator {

	private static final String TEST_CONTEXT_HOLDER = "com.indi.hiring.architecture.context.holder.TestContextHolder";
